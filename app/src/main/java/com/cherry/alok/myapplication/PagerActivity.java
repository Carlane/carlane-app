...
public class PagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int color1 = ContextCompat.getColor(this, R.color.indigo_light);
        final int color2 = ContextCompat.getColor(this, R.color.indigo);
        final int color3 = ContextCompat.getColor(this, R.color.indigo_dark);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            TextView small_label = (TextView) rootView.findViewById(R.id.welcome_small_label);
            int count = getArguments().getInt(ARG_SECTION_NUMBER);
            String[] text= {"Carlane","Trusted","Hassle Free"};
            textView.setText(text[count -1]);

            img = (ImageView) rootView.findViewById(R.id.section_img);
            img.setBackgroundResource(bgs[getArguments().getInt(ARG_SECTION_NUMBER) - 1]);
            small_label.setText(bgs_text[getArguments().getInt(ARG_SECTION_NUMBER) - 1]);
